...
body {
  font-family: Heebo, "Segoe UI", Tahoma, Arial, sans-serif !important;
  color: #2F3B34 !important;
  /* Room to scroll focused card fields above the iOS keyboard */
...
.tab-button:has(img[src*="Visa" i], img[src*="visa" i], img[src*="Master" i], img[src*="master" i], img[src*="Mastercard" i], img[src*="mastercard" i], img[alt*="Visa" i], img[alt*="Master" i]) > span,
.tab-button:has(img[src*="Visa" i], img[src*="visa" i], img[src*="Master" i], img[src*="master" i], img[src*="Mastercard" i], img[src*="mastercard" i], img[alt*="Visa" i], img[alt*="Master" i]) > div {
...
.tab-button:has(img[src*="Visa" i], img[src*="visa" i], img[src*="Master" i], img[src*="master" i], img[src*="Mastercard" i], img[src*="mastercard" i], img[alt*="Visa" i], img[alt*="Master" i]) img {
